...
<div class="container-fluid p-5 opretImage " style="background-image: url('images/book6.webp'); background-size: cover; background-repeat: no-repeat; background-position:bottom; background-attachment: fixed ">
...
<script type="module">
    import BogTabel from "./js/bogtabel.js";
