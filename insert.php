...
<div class="container-fluid bg-light p-5 mb-5 mb-lg-0 opretImage" style=" background-image: url('images/book6.webp'); background-size: cover; background-repeat: no-repeat; background-position:top ; background-attachment: fixed">
   <div class="px-lg-5">
        <div class=" py-5 pb-5 px-lg-5 mb-5 mb-lg-0 ">
            <div class="bg-black ">
                <h1 class="text-white ps-3">Oprettelse af produkter</h1>
                <p class="text-white pb-3 ps-3 mb-0">Udfyld <span class="fst-italic text-success">ALLE</span> felterne og tryk på "opret produkt" knappen</p>
            </div>
            <?php
            if(!empty($_POST["data"])){
                $data = $_POST["data"];
            ...
            <form method="post" action="insert.php" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 offset-md-6 pb-3">
                        <button class="form-control btn btn-secondary text-white" type="submit" id="btnSubmit">Opret produkt</button>
                    </div>
                </div>
            </form>
        </div>
